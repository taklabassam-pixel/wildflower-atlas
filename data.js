const flowersData = [
    ...
    },
   {
    ...
    },
    {
      ...
      "season_ar": "أواسط الربيع ومطلع الصيف (نيسان - حزيران)",
      "environment_ar": "المنحدرات الصخرية الكلسية، المراعي الجبلية الجافة، والمساحات المفتوحة بين الصخور في العزونية",
      "story_ar": "نبتة عشبية برية معمرة فخمة تنتمي للفصيلة المصفورية (وكانت تُصنف سابقاً مع الزنبقيات). تمتاز بسيقانها الطويلة القوية التي ترتفع نحو السماء لتنتهي بنورة غنية بالأزهار الصفراء الجذابة، والتي تتحول عند نضجها وإثمارها إلى كبسولات مغزلية برتقالية جافة خشبيّة متوزعة على السيقان. تتناغم سيقانها النحيلة مع الرياح الجبلية وتضفي هيبة بصرية خاصة على التلال الصخرية المشمسة.",
      "growth_stages": [
        { 
          "stage_name_ar": "طور التزهير الأصفر النجمي الكامل والأوراق الأنبوبية", 
          "img_path": "images/asphodeline_lutea_st1.jpg", 
          "is_primary": false 
        },
        { 
          "stage_name_ar": "طور الإثمار المتقدم وجفاف الكبسولات المغزلية البرتقالية", 
          "img_path": "images/asphodeline_lutea_st2.jpg", 
          "is_primary": false 
        },
        { 
          "stage_name_ar": "طور التداخل الثمري (ظهور الكبسولات الخضراء اليافعة مع بقايا البتلات الصفراء)", 
          "img_path": "images/asphodeline_lutea_st3.jpg", 
          "is_primary": true 
        }
      ]
    },
    ...
    },
    {
      ...
      "scientific_name": "Centaurea iberica",
      "audio_ar": "audio/arabic/centaurea_ibérica_ar.mp3",
      "audio_lat": "audio/latin/centaurea_ibérica_lat.mp3",
      "season_ar": "أواخر الربيع ومطلع الصيف (أيار - تموز)",
      "environment_ar": "المراعي الجبلية المفتوحة، الأراضي الحصوية الجافة، وجوانب المسالك الصخرية المشمسة",
      "image": "images/centaurea_iberica_st2.jpg",
      "story_ar": "نبتة عشبية برية شوكية صلبة تنتمي للفصيلة النجمية (جنس المرّار)، وتعتبر من أكثر نباتات المفتوحات قدرة على حماية نفسها. تتفرد بنشوء رؤوس زهرية يطوقها طوق هندسي دفاعي من الأشواك المستقيمة الطويلة والحادة ذات اللون الأرجواني أو الوردي القرمزي الساحر الذي يتناقض بقوة مع اخضرار أوراقها الممتدة. تضفي هذه الأشواك الملونة هيبة بصرية فريدة على قمم السيقان وسط الأعشاب الجبلية الجافة.",
      "growth_stages": [
        { 
          "stage_name_ar": "طور النجمية الشوكية اليافعة وتلون الأشواك المركزية بالأرجواني", 
          "img_path": "images/centaurea_iberica_st1.jpg", 
          "is_primary": false 
        },
        { 
          "stage_name_ar": "طور تفتح الأشواك النجمية وبداية بروز اللون الأرجواني في قمة البرعم", 
          "img_path": "images/centaurea_iberica_st2.jpg", 
          "is_primary": false 
        },
        { 
          "stage_name_ar": "طور الإزهار الكامل (الكرة الأرجوانية)", 
          "img_path": "images/centaurea_iberica_st3.jpg", 
          "is_primary": true 
        }
      ]
    },
  ...
  {
      id: 58,
      name_ar: "القَرصَعَنَّةُ الكِرِيتِيَّةُ (شَوْكَةُ الأَزْرَقِ / قَرصَعَنَّة المُرُوجِ)",
      scientific_name: "Eryngium creticum",
      audio_ar: "audio/arabic/eryngium_creticum_ar.mp3",
      audio_lat: "audio/latin/eryngium_creticum_lat.mp3",
      season: "مطلع الصيف إلى مطلع الخريف (حزيران - أيلول)",
      environment: "المنحدرات الجبلية الجافة، الأراضي المهملة والمشمسة، وحواف المسالك الحصوية",
      story: "نبتة عشبية برية شوكية معمرة ومقاومة للجفاف من الفصيلة الخيمية. تشتهر بهيكلها المتفرع النحيل وقناباتها الشوكية الطويلة الصلبة التي تحيط برؤوسها الزهرية الكروية كالنجم المشع. تبدأ دورة حياتها بلون أخضر فضي باهت وسط الحقول الجافة، ومع اشتداد حرارة الصيف، تكتسب سيقانها ورؤوسها لوناً أزرق بنفسجياً معدنياً ساحراً يمنح المروج الجافة هيبة بصرية خاصة.",
      growth_stages: [
        {
          stage_name: "طور النمو الخضري الفضي وبروز البراعم النجمية اليافعة (المرحلة الأولى)",
          img_path: "images/eryngium_creticum_st1.jpg",
          is_primary: true
        }
      ]
    },
    {
          id: 59,
          name_ar: "أُقْحُوَانُ الأَزْرَارِ الذَّهَبِيَّةِ الكُرَوِيَّةِ",
          scientific_name: "Lonas annua (cf.)", // الرمز cf يعني يقارن به أو شبيه به علمياً
          audio_ar: "audio/arabic/lonas_annua_ar.mp3",
          audio_lat: "audio/latin/lonas_annua_lat.mp3",
          season: "أواخر الربيع ومطلع الصيف (أيار - حزيران)",
          environment: "المروج الجبلية الجافة، حواف الصخور، والأراضي العشبية المفتوحة",
          image: "images/lonas_annua.jpg",
          story: "عشبة برية لافتة تنتمي للفصيلة النجمية، تمتاز برؤوسها الزهرية ذات الاستدارة الكروية المنتظمة والكاملة، ولونها الأصفر الذهبي الفاقع الذي يشبه الأزرار المصمتة. تنمو بشكل مستقل فوق سيقان أنبوبية مرنة وطويلة متداخلة مع نباتات المروج البرية مثل البرسيم، وتخلو تماماً من البتلات الشعاعية المحيطية مما يمنحها مظهراً هندسياً فريداً في الطبيعة.",
          growth_stages: [
            {
              stage_name: "طور التزهير الكامل وبروز الأزرار الكروية الصفراء المنتظمة",
              img_path: "images/lonas_annua.jpg",
              is_primary: true
            }
          ]
        }
